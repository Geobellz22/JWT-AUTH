...
class Conversation(models.Model):
    ...
    agent = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="agent_conversations", on_delete=models.SET_NULL, null=True, blank=True)
...
class Notification(models.Model):
    ...
    conversation = models.ForeignKey(Conversation, related_name="notifications", on_delete=models.CASCADE)
